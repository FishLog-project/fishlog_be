...
public record ForecastResponse(
    ...
    @Schema(description = "낚시지수 점수", example = "60") String lastScr,
    @Schema(description = "물때 점수", example = "50") String tdlvHrScr,
    @Schema(description = "물때 내용", example = "5물") String tdlvHrCn,
